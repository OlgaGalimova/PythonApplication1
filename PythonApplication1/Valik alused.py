...
#день_рождения_пользователя = int(input("Введите свой день рождения в формате день.месяц: "))
## Ввод сегодняшней даты
#дата_сегодня = int(input("Введите сегодняшнюю дату в формате день.месяц: "))
## Проверка на годовщину
#if (дата_сегодня - день_рождения_пользователя)%10==0:
