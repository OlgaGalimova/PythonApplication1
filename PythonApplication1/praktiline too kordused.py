...
import random
print("Привет! Я программа ответов.")
print("Задавай мне вопросы с ответами 'да' или 'нет'.")
ответы = ["Да, конечно!", "Да!", "Возможно!", "Нет!"]
while True:
    вопрос = input("Задай вопрос (да/нет): ")
    if вопрос.lower() == 'пока':
        break
    случайное_число = random.randint(1, 10)
    print(f"Мой ответ: {ответ}")
    print(f"Случайное число: {случайное_число}")

print("Спасибо за вопросы! До свидания!")
